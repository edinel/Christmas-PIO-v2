// Auto-generated by tools/generate_strings.py — do not edit directly
// Edit src/web/index.html and src/web/style.css instead

const char index_html[] PROGMEM = /* html */ R"rawliteral(
<!DOCTYPE HTML><html>
<head>
...
const char CSS_CODE[] PROGMEM = /* css */ R"rawliteral(
@keyframes fade {
    0%, 50% {
        opacity: 0;
        transform: scale(0);
